...
![Official Mascot](https://github.com/f1stnpm3/molestiae-beatae-nisi/raw/main/diagrams/Mascot.jpg)
...
With @f1stnpm3/molestiae-beatae-nisi, you can easily create a description for each API and code against getting values by hash.  This abstracts the complexity of multiple API services without requiring you to marshal it into your own persistence format.
...
These two JSON files are in the [examples/chocula](https://github.com/f1stnpm3/molestiae-beatae-nisi/tree/main/examples/chocula) folder along with a javascript file `Chocula.js` you can try out yourself and hack on.
